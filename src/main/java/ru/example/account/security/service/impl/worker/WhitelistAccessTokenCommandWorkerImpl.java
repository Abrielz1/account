...
public class WhitelistAccessTokenCommandWorkerImpl implements WhitelistAccessTokenCommandWorker {

    private static final String ERROR_NULL_OR_EMPTY_KEY_MESSAGE = "Key MUST NOT be NULL OR EMPTY!";

    private static final String KEY_STATUS_WHITELISTED = "white_listed_access_token";
